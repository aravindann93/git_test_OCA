sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("git_test/git_test/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("git_test.git_test.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["git_test/git_test/localService/mockserver"], function (mockserver) {
