sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("git_test.git_test.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias git_test.git_test.controller.ListSelector
			 */
			 ...
			 * @return {git_test.git_test.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
